...
# Auth, user profile, Twilio provisioning
from routes.auth import router as auth_router
app.include_router(auth_router)

# Config, calendar, integrations, prompt generation
...
# --- AUTH/SHEETS/CONFIG ENDPOINTS MOVED TO routes/ ---
...
# --- CONFIG/PROFILE/PROMPT/SHEETS ENDPOINTS MOVED TO routes/ ---
